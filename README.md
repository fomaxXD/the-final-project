...
Авторизация
На главное странице кнопка "создать вишлист". Если пользователь не входил в аккаунт, то его прекинет на авторизацию.
После авторизации есть 3 страниц на выыбор:
